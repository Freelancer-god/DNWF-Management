...
function CustomForm() {
    ...
    const handleOnChildChange = (data) => {
        ...
        const { _name, _email, _status, _username, password, _roleId, _role } =
            data;
            ...
            .then((values) => {
                ...
                if (_id) {
                    ...
                    dispatch(update()).then(({ payload }) => {
                        if (payload) {
                            navigate("/cms/employees?view_type=list");
                        }
                    });
                } else {
                    // new
    ...
    const breadcrumbNameMap = {
        "?view_type=list": tt("Danh sách nhân viên"),
        ...
        >
            <div style={{ paddingLeft: "10px", paddingRight: "10px" }}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        {myPermissions[PERMISSIONS_MAP["update-employee"]] && (
                            <Button
                                type="primary"
