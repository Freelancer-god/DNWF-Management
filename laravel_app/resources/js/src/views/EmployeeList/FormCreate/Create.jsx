...
import { spinnerCreate } from "../../../store/EmployeeList";
...
function Create(props) {
    ...
    useEffect(() => {
        if (data) {
            const { _id, _name, _email, _username, _status, _roleId, _role } =
                data;
            setId(_id);
            setName(_name);
            setEmail(_email);
    ...
    useEffect(() => {
        ...
        // for control
        handleOnChangeData(dataToSend);
    }, [_name, _email, _status, _username, password, _roleId, _role]);
    ...
    const handleOnChangeSelectRole = (value) => {
        setRoleId(value?.value ? value.value : value);
    };
