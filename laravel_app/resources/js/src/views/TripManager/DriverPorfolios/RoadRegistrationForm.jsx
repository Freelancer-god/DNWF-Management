...
function RoadRegistrationForm({ record, form, submitedForms }) {
  ...
  const renderConfirmRadio = () => (
    <>
      ...
      >
        <Radio.Group value={null} disabled={roadRegistration.status !== DRIVER_FORM_STATUS.NOT_VERIFIED} onChange={(e) => setStatusType4(e.target.value)}>
      ...
      {form.getFieldValue('status_type_5') === DRIVER_FORM_STATUS.DENINED && (
        <Form.Item
          label={tt('Lý do')}
          name="note_type_5"
          rules={[
        ...
        >
          <TextArea rows={2} maxLength={200} placeholder={tt('Nhập lý do vì sao không hợp lệ')} allowClear disabled={roadRegistration.status !== DRIVER_FORM_STATUS.NOT_VERIFIED} />
        </Form.Item>
      )}
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-[20px] flex flex-wrap md:flex-nowrap items-start gap-[10px]">
          ...
          <div className="overflow-hidden relative">
            {roadRegistration && (<PhotosViewer photos={roadRegistration?.medias} />)}
