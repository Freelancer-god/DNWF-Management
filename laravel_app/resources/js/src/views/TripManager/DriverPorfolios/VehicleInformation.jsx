...
function VehicleInformation({
  ...
  const generateDataToSend = (values, saveOnly = false) => {
    const {
      registration_certificate, insurance_civil_accident_date, vehicle_brand_id, vehicle_type_id, model_name,
      color, engine_number, frame_number, license_plates, is_owner, model_name_id, model_years, type_name, vehicle_brand_model_id,
      status_type_1, status_type_2, status_type_3, note_type_1, note_type_2, note_type_3, insurance_civil_accident_price,
      brand_name,
    } = values;
    const generatedData = {
      driver_id: userId,
      form_list: [{
        id: submitedForms[VEHICLE_INFOMATION_TYPE.DKX] ? submitedForms[VEHICLE_INFOMATION_TYPE.DKX].id : null,
        data: {
          color,
          engine_number,
          frame_number,
          ...
          license_plates,
          model_name,
          model_years: model_years.get('year'),
      ...
      {
        id: submitedForms[VEHICLE_INFOMATION_TYPE.HAX] ? submitedForms[VEHICLE_INFOMATION_TYPE.HAX].id : null,
      },
      {
        id: submitedForms[VEHICLE_INFOMATION_TYPE.BHBBTNDS] ? submitedForms[VEHICLE_INFOMATION_TYPE.BHBBTNDS].id : null,
        data: {
          insurance_civil_accident_date: insurance_civil_accident_date ? insurance_civil_accident_date.format('YYYY-MM-DD') : null,
    ...
    if (status_type_1 !== undefined || status_type_2 !== undefined || status_type_3 !== undefined) {
      if (saveOnly) {
        generatedData.form_list[0].status = submitedForms[VEHICLE_INFOMATION_TYPE.DKX].status;
        generatedData.form_list[1].status = submitedForms[VEHICLE_INFOMATION_TYPE.HAX].status;
        generatedData.form_list[2].status = submitedForms[VEHICLE_INFOMATION_TYPE.BHBBTNDS].status;
  ...
  return (
    <>
      <div className="flex flex-wrap gap-[10px]">
        ...
        <>
          <div className="max-w-[500px] overflow-hidden break-words mr-[5px] relative">
            {decodedMedia && (<PhotosViewer photos={decodedMedia[VEHICLE_INFOMATION_TYPE.BHBBTNDS]} />)}
          </div>
          ...
          <div className="max-w-[500px] overflow-hidden break-words mr-[5px] relative">
            {decodedMedia && (<PhotosViewer photos={decodedMedia[VEHICLE_INFOMATION_TYPE.DKX]} />)}
          </div>
          <div className="max-w-[500px] overflow-hidden break-words mr-[5px] relative">
            {decodedMedia && (<PhotosViewer photos={decodedMedia[VEHICLE_INFOMATION_TYPE.HAX]} />)}
          </div>
        </>
        )}
      ...
      >
        ...
        <VehicleInformationForm record={decodedMedia} form={form} submitedForms={submitedForms} />
      </Modal>
    </>
  );
}
