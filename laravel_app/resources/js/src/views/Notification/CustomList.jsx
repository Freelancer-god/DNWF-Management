...
function CustomList() {
    ...
    const handleMenuClick = (e) => {
        switch (e.key) {
            ...
            case "1":
                confirm({
                    title: tt("Xoá thông báo"),
                    icon: <ExclamationCircleFilled />,
                    content: `${tt("Bạn có chắc chắn muốn xóa thông báo")} "${
                        _selectedRows[0].title
                    }" ?`,
                    onOk() {
    ...
    const listField = [
        ...
        {
            label: tt("Loại gửi"),
            value: "notifications.send_type",
            type: "select",
            selectOption: [
                { label: tt("Gửi một lần"), value: 1 },
                { label: tt("Gửi hằng ngày"), value: 2 },
                { label: tt("Gửi hằng tuần"), value: 3 },
                { label: tt("Gửi hằng tháng"), value: 4 },
            ],
        },
        {
            label: tt("Gửi cho"),
            ...
            type: "select",
            selectOption: [
                { label: tt("Gửi tất cả"), value: 1 },
                { label: tt("Gửi cho khách hàng"), value: 2 },
                { label: tt("Gửi cho tài xế"), value: 3 },
            ],
        },
        {
            label: tt("Ngày gửi"),
            value: "notifications.send_date",
            type: "date",
        },
        {
            label: tt("Ngày tạo"),
        ...
        // { label: tt("Thời gian kết thúc"), value: "roles.end_date", type: "date" },
        {
            ...
            selectOption: [
                ...
                { label: tt("Chuẩn bị gửi"), value: 1 },
                { label: tt("Đã gửi"), value: 1 },
            ],
        },
    ].concat(commonFiledDynamicFilter("notifications"));
    ...
    const listAvailableFilter = [
        ...
        //   ],
        // },
    ].concat(commonTimeAvailableDynamicFilter("notifications"));
                        ...
                        <div>
                            <div>
                                <Select
                                    ...
                                    placeholder={tt("Tìm theo tiêu đề...")}
                    ...
                    <div className="bp950:grid bp950:grid-cols-2 bp950:gap-4">
                        <div>
                            <div className="bp375:grid bp375:grid-cols-2 bp375:gap-4">
                                ...
                                {hasSelection() &&
                                    myPermissions[
                                        PERMISSIONS_MAP["delete-notification"]
                                    ] && (
                                        <div>
                                            <Dropdown
                                                menu={{
