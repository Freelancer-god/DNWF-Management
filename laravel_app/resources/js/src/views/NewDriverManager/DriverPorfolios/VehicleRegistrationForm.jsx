...
function VehicleRegistrationForm({ record, form, submitedForms }) {
    ...
    useEffect(() => {
        if (submitedForms && submitedForms[VEHICLE_INFOMATION_TYPE.GCNDK]) {
            setVehicleRegistration(
                submitedForms[VEHICLE_INFOMATION_TYPE.GCNDK]
            );
        }
    ...
    useEffect(() => {
        ...
        const fieldsValue = {
            ...(vehicleRegistration.status !== DRIVER_FORM_STATUS.NOT_VERIFIED
    ...
    const renderConfirmRadio = () => (
        <>
            ...
            {form.getFieldValue("status_type_4") ===
          ...
          />
                ...
                <div className="mt-[20px] flex flex-wrap md:flex-nowrap items-start gap-[10px]">
                    ...
                    <div className="overflow-hidden relative w-[100%]">
                        {vehicleRegistration && (
                            <PhotosViewer
                                photos={vehicleRegistration?.medias}
