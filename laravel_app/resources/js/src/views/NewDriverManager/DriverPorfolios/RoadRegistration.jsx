...
function RoadRegistration({ data, userId, submitedForms, onUpdate }) {
    ...
    const generateDataToSend = (values, saveOnly = false) => {
        const { status_type_5, note_type_5 } = values;
        const generatedData = {
            driver_id: userId,
            form_list: [
                {
                    id: submitedForms[VEHICLE_INFOMATION_TYPE.GNPSDDB]
                        ? submitedForms[VEHICLE_INFOMATION_TYPE.GNPSDDB].id
                        : null,
                },
            ],
        };
        ...
        if (status_type_5 !== undefined) {
            if (saveOnly) {
                generatedData.form_list[0].status =
                    submitedForms[VEHICLE_INFOMATION_TYPE.GNPSDDB].status;
        ...
        <div className="max-w-[350px] overflow-hidden break-words mr-[10px]">
          ...
          <div className="flex flex-row mb-0 ">
            ...
            {data?.insurance_civil_accident_price
                ...
                {decodedMedia && (
                    <PhotosViewer
                        photos={decodedMedia[VEHICLE_INFOMATION_TYPE.GNPSDDB]}
                    />
                )}
            </div>
