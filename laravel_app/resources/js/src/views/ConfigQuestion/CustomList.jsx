...
function CustomList() {
    ...
    const items = [
        ...
        //   key: '0',
        // },
        ...(myPermissions[PERMISSIONS_MAP["delete-question"]]
            ? [
                  {
                      label: tt("Xoá"),
                      key: "1",
    ...
    const handleOnPressCreate = () => {
        ...
        navigate("/cms/configQuestion?view_type=form");
    };
    ...
    const handleMenuClick = (e) => {
        switch (e.key) {
            ...
            case "1":
                confirm({
                    title: tt("Xoá câu hỏi"),
                    icon: <ExclamationCircleFilled />,
                    content: `${tt("Bạn có chắc chắn muốn xóa câu hỏi")} "${
    ...
    const listField = [
        { label: tt("Câu hỏi"), value: "questions.title", type: "input" },
    ...
    const breadcrumbItems = [
        {
            title: (
                <Link to="/cms/configQuestion">{tt("Danh sách câu hỏi")}</Link>
            ),
                        ...
                        <div>
                            <div>
                                <Select
                                    ...
                                    placeholder={tt("Tìm theo tên câu hỏi...")}
                        ...
                        <div>
                            <div className="bp375:grid bp375:grid-cols-2 bp375:gap-4">
                                <div>
                                    <div>
                                        {myPermissions[
                                            PERMISSIONS_MAP["create-question"]
                                        ] && (
                                            <Button
                                                type="primary"
