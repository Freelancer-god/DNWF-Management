...
import { spinnerCreate } from '../../../store/DriverManager';
import {
  khach_hang,
  quan_ly_chuyen_di,
  tai_xe,
...
function Create(props) {
  ...
  const [_notificationAutoExpandParent, setNotificationAutoExpandParent] = useState(data._notificationAutoExpandParent);
            ...
            <div>
              <div>
                <label htmlFor="_giai_thich">
                  <strong>
                    Những phân quyền được sử dụng trong hệ thống
                  </strong>
                </label>
              </div>
            </div>
