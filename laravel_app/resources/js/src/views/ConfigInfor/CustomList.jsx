...
function CustomList() {
    ...
    const handleOnPressCreate = () => {
        ...
        navigate("/cms/configInfor?view_type=form");
    };
    ...
    const listField = [
        { label: tt("Tên cấu hình"), value: "configs.name", type: "input" },
    ...
    ].concat(commonFiledDynamicFilter("configs"));
    ...
    const listAvailableFilter = [
        ...
        //   ],
        // },
    ].concat(commonTimeAvailableDynamicFilter("configs"));
    ...
    const breadcrumbItems = [
        {
            title: (
                <Link to="/cms/configInfor">{tt("Danh sách cấu hình")}</Link>
            ),
                        ...
                        <div>
                            <div>
                                <Select
                                    ...
                                    placeholder={tt("Tìm theo tên cấu hình...")}
