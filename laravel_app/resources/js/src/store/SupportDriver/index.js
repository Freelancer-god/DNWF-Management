...
export const getData = createAsyncThunk(
    'SupportDriver/getData_ConfigInfor',
    async (_, { getState }) => {
        const {
            search, order, dynamicFilter, page, limit,
        } = getState().supportDriver;
...
export const getItemByID = createAsyncThunk(
    'SupportDriver/getItemByID_ConfigInfor',
    async (_) => {
        const { id } = _;
...
export const quickGetItemByID = createAsyncThunk(
    'SupportDriver/quickGetItemByID_ConfigInfor',
    async (_) => {
        const { id } = _;
        const response = await fetchGetByID({ id });
        clog(response);
...
export const create = createAsyncThunk(
    'SupportDriver/create_ConfigInfor',
...
export const quickCreate = createAsyncThunk(
    'SupportDriver/quickCreate_ConfigInfor',
    async (_, { getState, dispatch }) => {
        const { name } = _ || getState().SupportDriver;
        const response = await fetchAdd({
            name,
        });
        dispatch(getData());
...
export const update = createAsyncThunk(
    'SupportDriver/update_ConfigInfor',
    async (_, { getState, dispatch }) => {
...
export const quickUpdate = createAsyncThunk(
    'SupportDriver/quickUpdate_ConfigInfor',
    async (_, { getState }) => {
        const { id, name } = _ || getState().SupportDriver;
        const response = await fetchUpdate({
            id,
            name,
        });
...
export const deleteItem = createAsyncThunk(
    'SupportDriver/deleteItem_ConfigInfor',
    async (_, { getState, dispatch }) => {
        const { selectedRows } = getState().supportDriver;
...
export const deleteMulti = createAsyncThunk(
    'SupportDriver/deleteMulti_ConfigInfor',
    async (_, { getState, dispatch }) => {
        const { selectedRows } = _ || getState().SupportDriver;
...
export const SupportDriver = createSlice({
    name: 'SupportDriver',
    initialState,
    reducers: {
        // list
...
export const {
    ...
    changeStatus,
    changeDataConfig
} = SupportDriver.actions;
export const selectedRows = (state) => state.supportDriver.selectedRows;
export const search = (state) => state.supportDriver.search;
export const page = (state) => state.supportDriver.page;
export const limit = (state) => state.supportDriver.limit;
export const order = (state) => state.supportDriver.order;
export const data = (state) => state.supportDriver.data;
export const total = (state) => state.supportDriver.total;
export const spinnerSearch = (state) => state.supportDriver.spinnerSearch;
// FILTER
export const dynamicFilter = (state) => state.supportDriver.dynamicFilter;
// CREATE
export const showModalCreate = (state) => state.supportDriver.showModalCreate;
export const id = (state) => state.supportDriver.id;
export const updateItem = (state) => state.supportDriver.updateItem;
export const name = (state) => state.supportDriver.name;
export const value = (state) => state.supportDriver.value;
export const type = (state) => state.supportDriver.type;
export const status = (state) => state.supportDriver.status;
export const dataConfig = (state) => state.supportDriver.dataConfig;

export const spinnerCreate = (state) => state.supportDriver.spinnerCreate;
export const optionTypes = (state) => state.supportDriver.optionTypes;
export default SupportDriver.reducer;
