...
export const fetchGetList = (
    ...
    return axios
        .post(generateUrl('api/cmsService/v1/vehicles/search'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
...
export const exportVehicles = (dataToSend) => {
    const config = {
        headers: { Authorization: `Bearer ${document.getElementById('myToken')?.value}` },
    };
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/vehicles/exportExcel'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
...
export const exportVehiclesInsurance = (dataToSend) => {
    const config = {
        headers: { Authorization: `Bearer ${document.getElementById('myToken')?.value}` },
    };
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/vehicles/exportInsuranceExcel'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
