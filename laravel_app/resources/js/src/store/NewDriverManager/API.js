...
export const fetchGetList = (
    ...
    return axios
        .post(generateUrl('api/cmsService/v1/drivers/search'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
...
export const toggleActivity = ({
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/drivers/updateStatus'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
...
export const resetDocumentForms = ({
    driver_id,
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/drivers/changeDriverType'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
...
export const exportDrivers = (dataToSend) => {
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/drivers/exportExcel'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
...
export const exportExcelNew = (dataToSend) => {
    const config = {
        headers: { Authorization: `Bearer ${document.getElementById('myToken')?.value}` },
    };
    ...
    clog('dataToSend', dataToSend);
    return axios
        .post(generateUrl('api/cmsService/v1/drivers/exportExcelNew'), dataToSend, config)
        .then((res) => res.data)
        .then((data) => {
            if (data.success === false) {
                showError(data.error);
